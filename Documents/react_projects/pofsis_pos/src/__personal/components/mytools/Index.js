...
export const Index = ({ myTool }) => {
    ...
    const { tool_state, tool_category_state } = useContext(ToolContext)
            ...
            <Slide in={myTool.data} direction="left" className="noutlined">
                <Box height="100%" width="374px" bgcolor="#FFFFFF" boxShadow=" 0px 8px 16px 0px #00000014, 0px 0px 4px 0px #0000000A" py="24px"> 
                    <Box height="100%" display="flex" flexDirection="column" gap="24px">
                        ...
                        <Box height="100%" display="flex" flexDirection="column" gap="24px" className="overflowY" px="24px" pt="8px">
                            <Box display="grid" gridTemplateColumns="repeat(auto-fill,minmax(80px,1fr))" gap="4px">
                                <Box component={Button} disableFocusRipple={true} className={classes.btnpsl} width="100px" border="2px solid #3D77E9" borderRadius="6px" display="flex" flexDirection="column" alignItems="center" gap="12px" py="8px" bgcolor="#F0F5F9"
                                ...
                                <Box component={Button} disableFocusRipple={true} className={classes.btnbiz} width="100px" borderRadius="6px" display="flex" flexDirection="column" alignItems="center" gap="12px" py="8px" bgcolor="#F0F5F9"
                            ...
                            <Box width="100%" display="flex" flexDirection="column" gap="24px">
                                <Box display="grid" gridTemplateColumns="repeat(auto-fill,minmax(80px,1fr))" gap="8px">
                                    {dfltTools.map((t,i) => (
                                        <Box component={Button} disableFocusRipple={true} className={classes.btnpsl} onClick={()=>handleClick(t.link)} key={i} minWidth="100px" borderRadius="6px" display="flex" flexDirection="column" alignItems="center" gap="12px" py="8px" bgcolor="#F0F5F9">
