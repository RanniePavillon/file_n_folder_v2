...
export const Index = () => {
    ...
    const { myTool, myToolPzl } = navigation_state
                ...
                if (name === 'psl') {
                    if (__SESSION.data.ainfo.account_type !== 2) {
                        ...
                        if (res.length > 0) {
                            ...
                            window.open(process.env.REACT_APP_URL_TOOL_BIZ+'/switching', '_blank').focus()
                        }
                    }
                }else{
                    ...
                    <Box height="100%" display="flex" flexDirection="column" gap="24px" >
                        ...
                        <Box height="100%" display="flex" flexDirection="column" gap="24px" className="overflowY" px="16px" pt="8px">
                            <Box display="grid" gridTemplateColumns="repeat(auto-fill,minmax(100px,1fr))" gap="12px">
                                <Box component={Button} disableFocusRipple={true} className={classes.btnpsl} minWidth="100px" borderRadius="6px" display="flex" flexDirection="column" alignItems="center" gap="12px" py="8px" bgcolor="#F8F9FA"
                                ...
                                >
                                    <Box component={Button} disableFocusRipple={true} className={myToolPzl.data ? classes.btnbizfocus : classes.btnbiz} minWidth="100px" borderRadius="6px" display="flex" flexDirection="column" alignItems="center" gap="12px" py="8px" bgcolor="#F8F9FA"
