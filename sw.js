var staticCacheName = "pofyourtool-cache-v1.1.1";
var dynamicCacheName = "pofyourtool-cache-dynamic-1.1.1";
var filesToCache = [
    '/'
];
...
self.addEventListener('activate', event => {
    event.waitUntil(
        caches.keys().then(cacheNames => {
            return Promise.all(
                cacheNames
                    .filter(cacheName => (cacheName.startsWith('pofyourtool-cache')))
